...
- **Runtime / state**
  ...
  - `RETRY_MAX_MS` (default 8000)
  - `WS_CONNECT_TIMEOUT_MS` (default 15000)
  - `RETRY_LOG_VERBOSE=1` (optional; enable per-attempt retry logs; default is concise final-error only)
